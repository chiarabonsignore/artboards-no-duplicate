...
const duplicateArtboards: RuleDefinition = {
  ...
  name: 'artboards-no-duplicated/duplicate-artboards',
...
const duplicateSymbols: RuleDefinition = {
  ...
  name: 'artboards-no-duplicated/duplicate-symbols',
...
const duplicateLayerStyles: RuleDefinition = {
  ...
  name: 'artboards-no-duplicated/duplicate-layer-styles',
...
const duplicateTextStyles: RuleDefinition = {
  ...
  name: 'artboards-no-duplicated/duplicate-text-styles',
...
const assistant: AssistantPackage = async () => {
  return {
    ...
    config: {
      rules: {
        'artboards-no-duplicated/duplicate-artboards': { active: true }
      },
    },
  }
}
